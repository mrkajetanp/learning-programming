System.config({
  ...
  map: {
    ...
    "concurrently": "npm:concurrently@3.1.0",
    ...
    "npm:angular-in-memory-web-api@0.1.14": {
      "@angular/core": "npm:@angular/core@2.1.2",
      "@angular/http": "npm:@angular/http@2.1.2",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "reflect-metadata": "npm:reflect-metadata@0.1.8",
    ...
    "npm:concurrently@3.1.0": {
      ...
      "process": "github:jspm/nodelibs-process@0.1.2",
      "rx": "npm:rx@2.3.24",
      "spawn-default-shell": "npm:spawn-default-shell@1.1.0",
      "systemjs-json": "github:systemjs/plugin-json@0.1.2",
    ...
    "npm:lite-server@2.2.2": {
      "browser-sync": "npm:browser-sync@2.17.5",
      "connect-history-api-fallback": "npm:connect-history-api-fallback@1.3.0",
    ...
    "npm:yargs@6.0.0": {
      ...
      "y18n": "npm:y18n@3.2.1",
      "yargs-parser": "npm:yargs-parser@4.0.2"
    },
    "npm:zone.js@0.6.26": {
      "crypto": "github:jspm/nodelibs-crypto@0.1.0",
      "events": "github:jspm/nodelibs-events@0.1.1",
